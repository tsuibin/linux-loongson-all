...
#define LOONGSON_HTIO_BASE	loongson_htio_base
#define LOONGSON_HTIO_SIZE	0x00100000	/* 1M */

/* Loongson3A UART Base cww */
#ifdef CONFIG_CPU_UART
#define LOONGSON_UART_BASE	0x1fe001e0ULL	/* CPU UART */
#define CPU_UART0_MAP_BASE	LOONGSON_UART_BASE
#define CPU_UART1_MAP_BASE	(LOONGSON_UART_BASE + 0x8)
#define CPU_UART0_MEM_BASE	(0x9000000000000000 | CPU_UART0_MAP_BASE)
#define CPU_UART1_MEM_BASE	(0x9000000000000000 | CPU_UART1_MAP_BASE)
#else
#define LOONGSON_UART_BASE	0x1ff003f8ULL	/* CPU LPC UART */
#define CPU_LPC_UART_MAP_BASE	LOONGSON_UART_BASE
#define CPU_LPC_UART_MEM_BASE	(0xffffffffb0000000 | CPU_LPC_UART_MAP_BASE)
#endif
