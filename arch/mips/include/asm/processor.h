...
#define NUM_VPU_REGS	32
typedef __u64 vpureg_t[4];
#endif
...
#ifdef CONFIG_CPU_SUPPORTS_VECTOR_COPROCESSOR
struct mips_vpu_struct {
        vpureg_t        vpr[NUM_VPU_REGS];
};
#endif
...
#ifdef CONFIG_CPU_SUPPORTS_VECTOR_COPROCESSOR
	/* Saved vpu/vpu emulator stuff. */
        struct mips_vpu_struct vpu __attribute__((__aligned__(16)));
#endif
