...
#ifdef CONFIG_CPU_SUPPORTS_VECTOR_COPROCESSOR
void output_thread_vpu_defines(void)
{
	OFFSET(THREAD_VPR0, task_struct, thread.vpu.vpr[0]);
	OFFSET(THREAD_VPR1, task_struct, thread.vpu.vpr[1]);
	OFFSET(THREAD_VPR2, task_struct, thread.vpu.vpr[2]);
	OFFSET(THREAD_VPR3, task_struct, thread.vpu.vpr[3]);
	OFFSET(THREAD_VPR4, task_struct, thread.vpu.vpr[4]);
	OFFSET(THREAD_VPR5, task_struct, thread.vpu.vpr[5]);
	OFFSET(THREAD_VPR6, task_struct, thread.vpu.vpr[6]);
	OFFSET(THREAD_VPR7, task_struct, thread.vpu.vpr[7]);
	OFFSET(THREAD_VPR8, task_struct, thread.vpu.vpr[8]);
	OFFSET(THREAD_VPR9, task_struct, thread.vpu.vpr[9]);
	OFFSET(THREAD_VPR10, task_struct, thread.vpu.vpr[10]);
	OFFSET(THREAD_VPR11, task_struct, thread.vpu.vpr[11]);
	OFFSET(THREAD_VPR12, task_struct, thread.vpu.vpr[12]);
	OFFSET(THREAD_VPR13, task_struct, thread.vpu.vpr[13]);
	OFFSET(THREAD_VPR14, task_struct, thread.vpu.vpr[14]);
	OFFSET(THREAD_VPR15, task_struct, thread.vpu.vpr[15]);
	OFFSET(THREAD_VPR16, task_struct, thread.vpu.vpr[16]);
	OFFSET(THREAD_VPR17, task_struct, thread.vpu.vpr[17]);
	OFFSET(THREAD_VPR18, task_struct, thread.vpu.vpr[18]);
	OFFSET(THREAD_VPR19, task_struct, thread.vpu.vpr[19]);
	OFFSET(THREAD_VPR20, task_struct, thread.vpu.vpr[20]);
	OFFSET(THREAD_VPR21, task_struct, thread.vpu.vpr[21]);
	OFFSET(THREAD_VPR22, task_struct, thread.vpu.vpr[22]);
	OFFSET(THREAD_VPR23, task_struct, thread.vpu.vpr[23]);
	OFFSET(THREAD_VPR24, task_struct, thread.vpu.vpr[24]);
	OFFSET(THREAD_VPR25, task_struct, thread.vpu.vpr[25]);
	OFFSET(THREAD_VPR26, task_struct, thread.vpu.vpr[26]);
	OFFSET(THREAD_VPR27, task_struct, thread.vpu.vpr[27]);
	OFFSET(THREAD_VPR28, task_struct, thread.vpu.vpr[28]);
	OFFSET(THREAD_VPR29, task_struct, thread.vpu.vpr[29]);
	OFFSET(THREAD_VPR30, task_struct, thread.vpu.vpr[30]);
	OFFSET(THREAD_VPR31, task_struct, thread.vpu.vpr[31]);
	BLANK();
}
#endif
