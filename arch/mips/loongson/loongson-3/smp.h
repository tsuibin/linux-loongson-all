...
#define smp_core0_offset	(phy_core_id[0] << 8)
#define smp_core1_offset	(phy_core_id[1] << 8)
#define smp_core2_offset	(phy_core_id[2] << 8)
#define smp_core3_offset	(phy_core_id[3] << 8)
