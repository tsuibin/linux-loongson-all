 ...
 * \return  void 
 */
static void __inline__ synopGMACWriteReg(u32 * RegBase, u32 RegOffset,
					 u32 RegData)
{
 ...
 * \return  void 
 */
static void __inline__ synopGMACSetBits(u32 * RegBase, u32 RegOffset,
					u32 BitPos)
{
	void *addr = (void *)RegBase + RegOffset;
	u32 data = readl((void *)addr);
 ...
 * \return  void 
 */
static void __inline__ synopGMACClearBits(u32 * RegBase, u32 RegOffset,
					  u32 BitPos)
{
	void *addr = (void *)RegBase + RegOffset;
	u32 data = readl((void *)addr);
 ...
 * 
 */
static bool __inline__ synopGMACCheckBits(u32 * RegBase, u32 RegOffset,
					  u32 BitPos)
{
	void *addr = (void *)RegBase + RegOffset;
	u32 data = readl((void *)addr);
