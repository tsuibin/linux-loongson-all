...
static struct reg mmc[] = {
	...
	{0x0114,
	 "No. Of Bytes  Transmitted (Good/Bad)                            "},
	{0x0164,
	 "No. Of Bytes  Transmitted (Good)                                "},
	{0x0118,
	 "No. Of Frames Trsnsmitted (Good/Bad)                            "},
	{0x0168,
	 "No. Of Frames Trsnsmitted (Good)                                "},

	{0x013C,
	 "No. Of Unicast Frames Transmitted (Good/Bad)                    "},
	{0x011C,
	 "No. Of Broadcast Frames Transmitted (Good)                      "},
	{0x0140,
	 "No. Of Broadcast Frames Transmitted (Good/Bad)                  "},
	{0x0120,
	 "No. Of Multicast Frames Transmitted (Good)                      "},
	{0x0144,
	 "No. Of Multicast Frames Transmitted (Good/Bad)                  "},

	{0x0124,
	 "No. Of Tx frames with Length 64 bytes (Good/Bad)                "},
	{0x0128,
	 "No. Of Tx frames with Length <064,128> bytes (Good/Bad)         "},
	{0x012C,
	 "No. Of Tx frames with Length <128,256> bytes (Good/Bad)         "},
	{0x0130,
	 "No. Of Tx frames with Length <256,512> bytes (Good/Bad)         "},
	{0x0134,
	 "No. Of Tx frames with Length <512,1024> bytes (Good/Bad)        "},
	{0x0138,
	 "No. Of Tx frames with Length <1024,MaxSize> bytes (Good/Bad)    "},

	{0x0148,
	 "No. Of Tx aborted due to Underflow error                        "},
	{0x0158,
	 "No. Of Tx aborted due to Late Collision                         "},
	{0x015C,
	 "No. Of Tx aborted due to Excessive Collision                    "},
	{0x0160,
	 "No. Of Tx aborted due to Carrier Sense error                    "},
	{0x016C,
	 "No. Of Tx aborted due to Excessive Defferal error               "},

	{0x014C,
	 "No. Of Tx frames after single collision in Half Duplex mode     "},
	{0x0150,
	 "No. Of Tx frames after multiple collision in Half Duplex mode   "},
	{0x0154,
	 "No. Of Tx frames after a deferral                               "},

	{0x0170,
	 "No. Of Pause frames Transmitted   (Good)                        "},
	{0x0174,
	 "No. Of VLAM tagged frames Transmitted  (Good)                   "},

	{0x0184,
	 "No. Of Bytes  Received    (Good/Bad)                            "},
	{0x0188,
	 "No. Of Bytes  Received    (Good)                                "},
	{0x0180,
	 "No. Of Frames Received    (Good/Bad)                            "},

	{0x01C4,
	 "No. Of Unicast Frames Received (Good)                           "},
	{0x018C,
	 "No. Of Broadcast Frames Transmitted (Good)                      "},
	{0x0190,
	 "No. Of Multicast Frames Transmitted (Good)                      "},
	...
	{0x01AC,
	 "No. Of Rx frames with Length 64 bytes (Good/Bad)                "},
	{0x01B0,
	 "No. Of Rx frames with Length <064,128> bytes (Good/Bad)         "},
	{0x01B4,
	 "No. Of Rx frames with Length <128,256> bytes (Good/Bad)         "},
	{0x01B8,
	 "No. Of Rx frames with Length <256,512> bytes (Good/Bad)         "},
	{0x01BC,
	 "No. Of Rx frames with Length <512,1024> bytes (Good/Bad)        "},
	{0x01C0,
	 "No. Of Rx frames with Length <1024,MaxSize> bytes (Good/Bad)    "},

	{0x01A4,
	 "No. Of Runt Rx frames with frames (<64)                         "},
	{0x01A8,
	 "No. Of Jabber Rx frames with frames (>1518)                     "},
	{0x0194,
	 "No. Of Rx frames with CRC error                                 "},
	{0x0198,
	 "No. Of Rx frames with dribble error (only in 10/100)            "},
	{0x019C,
	 "No. Of Rx frames with runt error (<64 and CRC error)            "},
	{0x01A0,
	 "No. Of Rx frames with jabber error (>1518 and CRC)              "},
	{0x01D4,
	 "No. Of Rx frames missed due to FIFO overflow                    "},
	{0x01DC,
	 "No. Of Rx frames received with watchdog timeout error           "},
	{0x01C8,
	 "No. Of Rx frames with Length != Frame Size                      "},
	{0x01CC,
	 "No. Of Rx frames with Length != Valid Frame Size                "},

	{0x0170,
	 "No. Of Pause frames Received (Good)                             "},
	{0x0174,
	 "No. Of VLAM tagged frames Received (Good)                       "},

	{0x0210,
	 "No. Of IPV4 Packets  Received (Good)                            "},
	{0x021C,
	 "No. Of IPV4 Packets with fragmentation Received                 "},
	{0x0220,
	 "No. Of IPV4 Packets with UDP checksum disabled                  "},

	{0x0214,
	 "No. Of IPV4 Packets with Header Error Received                  "},
	{0x0218,
	 "No. Of IPV4 Packets with No Payload Error Received              "},

	{0x0224,
	 "No. Of IPV6 Packets  Received (Good)                            "},

	{0x0228,
	 "No. Of IPV4 Packets with Header Error Received                  "},
	{0x022C,
	 "No. Of IPV6 Packets with No Payload Error Received              "},

	{0x0240,
	 "No. Of ICMP Frames Received (Good)                              "},
	{0x0244,
	 "No. Of ICMP Frames Received with Error                          "},

	{0x0230,
	 "No. Of UDP Frames Received (Good)                               "},
	{0x0234,
	 "No. Of UDP Frames Received with Error                           "},

	{0x0238,
	 "No. Of TCP Frames Received (Good)                               "},
	{0x023C,
	 "No. Of TCP Frames Received with Error                           "},
...
static int read(char *ifname, int argc, char *argv[])
{
	...
	if (((data.unit == 0) && (data.addr > 0x000002FC))
	    || ((data.addr & 0x00000003) != 0))
		return 1;
	if (((data.unit == 1) && (data.addr > 0x00000058))
	    || ((data.addr & 0x00000003) != 0))
		return 1;
...
static int wcs(int cmd, char *ifname, char *cmdname, int argc, char *argv[])
{
	...
	printf("%s %s 0x%08x to %s Register 0x%02x\n", ifname, cmdname,
	       data_to_write, argv[0], data.addr);
...
static int status(char *ifname, int argc, char *argv[])
{
	...
	if (retval < 0) {
		...
		printf
		    ("GMAC ip Version                              = 0x%08x\n",
		     gmacdev.Version);
		printf
		    ("GMAC   Register Base Address                 = 0x%08x\n",
		     gmacdev.MacBase);
		printf
		    ("DMA    Register Base Address                 = 0x%08x\n",
		     gmacdev.DmaBase);
		printf
		    ("PHY device Base Address(32 phys possible)    = 0x%08x\n",
		     gmacdev.PhyBase);
		...
		printf("Next Available Tx Descriptor                 = %d\n",
		       gmacdev.TxNext);
		printf
		    ("MDC clock division number                    = 0x%08x\n",
		     gmacdev.ClockDivMdc);
		printf
		    ("Link State information                       = 0x%08x\n",
		     gmacdev.LinkState);
		printf
		    ("Duplex Mode of the Interface                 = 0x%08x\n",
		     gmacdev.DuplexMode);
		printf
		    ("Speed of the Interface                       = 0x%08x\n",
		     gmacdev.Speed);
		printf
		    ("LoopBack status of the Interface             = 0x%08x\n",
		     gmacdev.LoopBackMode);

		printf("\n");
#ifdef ENH_DESC
		printf
		    ("RxD Idx:   Status      length      buffer1     buffer2     data1       data2     Ext_status  reserved       TSL         TSH    \n");
		printf
		    ("---------------------------------------------------------------------------------------------------------------------------- \n");
		for (count = 0; count < gmacdev.RxDescCount; count++) {
			...
			if (retval < 0)
				break;
			printf
			    ("RxD  %02x: 0x%08x  0x%08x  0x%08x  0x%08x  0x%08x  0x%08x  0x%08x  0x%08x  0x%08x  0x%08x\n",
			     count, dmadesc.status, dmadesc.length,
			     dmadesc.buffer1, dmadesc.buffer2, dmadesc.data1,
			     dmadesc.data2, dmadesc.extstatus,
			     dmadesc.reserved1, dmadesc.timestamplow,
		...
		printf
		    ("TxD Idx:   Status      length      buffer1     buffer2     data1       data2   reserved      reserved      TSL           TSH \n");
		printf
		    ("---------------------------------------------------------------------------------------------------------------------------- \n");
		for (count = 0; count < gmacdev.TxDescCount; count++) {
			...
			if (retval < 0)
				break;
			printf
			    ("TxD  %02x: 0x%08x  0x%08x  0x%08x  0x%08x  0x%08x  0x%08x   0x%08x  0x%08x  0x%08x  0x%08x\n",
			     count, dmadesc.status, dmadesc.length,
			     dmadesc.buffer1, dmadesc.buffer2, dmadesc.data1,
			     dmadesc.data2, dmadesc.extstatus,
			     dmadesc.reserved1, dmadesc.timestamplow,
		...
		for (count = 0; count < gmacdev.RxDescCount; count++) {
			...
			if (retval < 0)
				break;
			printf
			    ("RxD  %02x: 0x%08x  0x%08x  0x%08x  0x%08x  0x%08x  0x%08x\n",
			     count, dmadesc.status, dmadesc.length,
			     dmadesc.buffer1, dmadesc.buffer2, dmadesc.data1,
			     dmadesc.data2);
		}
		...
		printf
		    ("TxD Idx:   Status      length      buffer1     buffer2     data1       data2 \n");
		printf
		    ("-----------------------------------------------------------------------------\n");
		for (count = 0; count < gmacdev.TxDescCount; count++) {
			dmadesc.data1 = count;
			...
			if (retval < 0)
				break;
			printf
			    ("TxD  %02x: 0x%08x  0x%08x  0x%08x  0x%08x  0x%08x  0x%08x \n",
			     count, dmadesc.status, dmadesc.length,
			     dmadesc.buffer1, dmadesc.buffer2, dmadesc.data1,
			     dmadesc.data2);
		}
...
//    if( strcmp( argv[2], "debug" ) == 0 )    retval = debug( argv[1], argc-3, argv+3 );
		if (strcmp(argv[2], "dump") == 0)
			retval = dump(argv[1], argc - 3, argv + 3);
		if (strcmp(argv[2], "write") == 0)
			retval =
			    wcs(wcs_write, argv[1], argv[2], argc - 3,
				argv + 3);
		if (strcmp(argv[2], "read") == 0)
			retval = read(argv[1], argc - 3, argv + 3);
		if (strcmp(argv[2], "set") == 0)
			retval =
			    wcs(wcs_set, argv[1], argv[2], argc - 3, argv + 3);
		if (strcmp(argv[2], "clr") == 0)
			retval =
			    wcs(wcs_clr, argv[1], argv[2], argc - 3, argv + 3);
		if (strcmp(argv[2], "status") == 0)
			retval = status(argv[1], argc - 3, argv + 3);
		if (strcmp(argv[2], "powerdown") == 0)
			retval = powerdown(argv[1], argc - 3, argv + 3);
	}
