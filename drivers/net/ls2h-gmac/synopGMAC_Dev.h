...
enum DmaBusModeReg {		/* Bit description                                Bits     R/W   Reset value */
...
enum InitialRegisters {
	...
	GmacFlowControlInitHdx =
	    GmacUnicastPauseFrameOff | GmacRxFlowControlDisable |
...
s32 synopGMAC_read_phy_reg(u32 * RegBase, u32 PhyBase, u32 RegOffset,
			   u16 * data);
s32 synopGMAC_write_phy_reg(u32 * RegBase, u32 PhyBase, u32 RegOffset,
			    u16 data);
...
bool synopGMAC_ES_is_rx_checksum_bypassed(synopGMACdevice * gmacdev,
					  u32 ext_status);
bool synopGMAC_ES_is_IP_payload_error(synopGMACdevice * gmacdev,
				      u32 ext_status);
/*******************PMT APIs***************************************/
...
void synopGMAC_disable_mmc_ipc_rx_interrupt(synopGMACdevice * gmacdev,
					    u32 mask);
