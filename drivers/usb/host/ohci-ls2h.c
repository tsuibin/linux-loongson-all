...
static int usb_hcd_ls2h_remove (struct usb_hcd *, struct platform_device *);
...
/**
 * usb_hcd_ls2h_probe - initialize AT91-based HCDs
...
/**
 * usb_hcd_ls2h_remove - shutdown processing for AT91-based HCDs
 * @dev: USB Host Controller being removed
 * Context: !in_interrupt()
 *
 * Reverses the effect of usb_hcd_ls2h_probe(), first invoking
...
ohci_ls2h_start (struct usb_hcd *hcd)
{
